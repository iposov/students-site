...
6. (немного исследования) Задача аналогична предыдущей, но вы должны использовать пространство LCH (почему LCH: [статья на хабр](https://habr.com/ru/company/ruvds/blog/496966/)). Оно не встроено в Java, поэтому найдите код, который превращает цвет из этого пространства в один из поддерживаемых: RGB или HSB.
7. Давайте сделаем настояющую радугу. В этот раз изображение должно иметь размер $750 - 380 + 1$ на $100$. По горизонтали длина волны (от 380 до 750), по вертикали все цвета будут одинаковые. Превратить длину волны в цвет RGB можно с помощью такого кода: [длина волны в RGB](https://gist.github.com/friendly/67a7df339aa999e2bcfcfec88311abfc), переведите этот код на Java, там `^` означает возведение в степень.
