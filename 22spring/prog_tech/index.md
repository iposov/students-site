...
6. Задача аналогична задаче про HSB, но вы должны использовать пространство LCH (почему LCH: [статья на хабр](https://habr.com/ru/company/ruvds/blog/496966/)). Оно не встроено в Java, поэтому возьмите этот код для преобразования: [LCH.java](../../20spring/prog-tech/lecture4-bitmaps/LCH.java)
