...
1. Реализуйте для точки следующие классы. Для встоенных в стандартную библиотеку
классов попробуйте проверить, что с классом `Point` начнут работать другие встроенные
функции.
